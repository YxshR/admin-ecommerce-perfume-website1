...
// Hard-coded leadership data to ensure it always displays
const leadershipData = [
  {
    ...
    position: 'founder',
    image: 'https://placehold.co/300x400/272420/FFFFFF?text=Arvind+Soni',
  ...
  },
  {
    ...
    position: 'ceo',
    image: 'https://placehold.co/300x400/272420/FFFFFF?text=Naresh+Dadhich',
  ...
  },
  {
    ...
    position: 'marketing',
    image: 'https://placehold.co/300x400/272420/FFFFFF?text=Gayatri+Soni',
  ...
  },
  {
    ...
    position: 'operations',
    image: 'https://placehold.co/300x400/272420/FFFFFF?text=Chinesh+Soni',
    bio: "Operations & IT Leadership: Mr. Chinesh Soni\n\nMr. Chinesh Soni heads the Operations and IT Management at AVITO Perfume, bringing a strong technical background and operational expertise to our organization. With his strategic approach to technology implementation and business process optimization, he ensures seamless operations across all departments.\n\nTechnical Excellence\nWith extensive experience in IT infrastructure and systems integration, Mr. Chinesh has revolutionized AVITO's technological capabilities. His expertise in implementing cutting-edge solutions has significantly enhanced our operational efficiency, supply chain management, and customer service capabilities.\n\nOperational Leadership\nAs the head of Operations, Mr. Chinesh oversees the day-to-day functioning of our production facilities, logistics, and distribution networks. His methodical approach to operational challenges and process improvement has been instrumental in scaling our business while maintaining consistent quality standards.\n\nDigital Transformation\nMr. Chinesh has led AVITO's digital transformation initiatives, implementing advanced e-commerce solutions and integrated management systems. His vision has helped bridge the gap between traditional perfumery and modern business practices, positioning AVITO at the forefront of innovation in the fragrance industry.\n\nCommitment to Efficiency and Innovation\nWith a focus on continuous improvement, Mr. Chinesh constantly explores new technologies and methodologies to enhance our operational capabilities. His dedication to innovation ensures that AVITO remains agile and responsive in an ever-evolving market landscape.\n\nOur Promise\nUnder Mr. Chinesh Soni's guidance, AVITO Perfume is committed to maintaining operational excellence while embracing technological advancement. We strive to create efficient systems and processes that ultimately translate to exceptional customer experiences and product quality."
  }
];
