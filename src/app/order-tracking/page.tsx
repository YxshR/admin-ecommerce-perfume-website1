...
export default function OrderTrackingPage() {
  ...
  const trackingIdFromUrl = searchParams.get('tracking_id');
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-medium mb-8">Track Your Order</h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4">
          ...
          <div className="self-end">
            <button
              type="submit"
              disabled={isLoading}
              className={`h-10 px-6 rounded-md text-white font-medium ${
      ...
      {orderDetails && (
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex justify-between items-center border-b pb-4 mb-6">
            <div>
              <h2 className="text-xl font-medium">Order #{orderDetails.trackingId}</h2>
